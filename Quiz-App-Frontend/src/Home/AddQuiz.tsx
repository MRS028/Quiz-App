...
const themedSwal = Swal.mixin({
  ...
  customClass: {
    ...
    confirmButton:
      "bg-red-600 hover:bg-red-700 text-white font-bold py-2 px-4 rounded-lg mx-2",
    cancelButton:
      "bg-slate-600 hover:bg-slate-700 text-white font-bold py-2 px-4 rounded-lg mx-2",
    title: "text-gray-100",
  },
        ...
        <div className="flex flex-col items-center">
          ...
          <p
            className={`mt-2 text-xs font-semibold ${
              currentStep >= index + 1 ? "text-gray-200" : "text-gray-500"
            }`}
          >
            {step}
          </p>
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent className="sm:max-w-[600px] bg-slate-900 border-slate-700 text-gray-200">
        ...
        <Stepper
          currentStep={addQuestionStep}
          steps={["Question", "Options", "Answer"]}
        />
        ...
        <div className="min-h-[200px] flex flex-col justify-center">
          {addQuestionStep === 1 && (
            <Input
              ...
              className="bg-slate-800 border-slate-600 focus:border-teal-500"
            />
          )}
          {addQuestionStep === 2 && (
          ...
          {addQuestionStep === 3 && (
            <div className="space-y-2">
              ...
              <select
                ...
                className="w-full p-2 mt-2 border rounded-md bg-slate-800 border-slate-600 text-gray-200 focus:border-teal-500 focus:ring-teal-500"
              >
        ...
        <DialogFooter className="mt-6">
          {addQuestionStep > 1 && (
            <Button
              ...
              className="border-slate-600 hover:bg-slate-700 text-black"
            >
          ...
          {addQuestionStep < 3 ? (
            ...
            >
              Add Question <Check className="w-4 h-4 ml-2" />
            </Button>
          )}
        </DialogFooter>
      </DialogContent>
    ...
    <>
      <Dialog open={open} onOpenChange={setOpen}>
        ...
        <DialogContent className="sm:max-w-[600px] bg-slate-900 border-slate-700 text-gray-200">
          ...
          <Stepper
            currentStep={step}
            steps={["Details", "Questions", "Review"]}
          />
          ...
          <div className="min-h-[350px]">
              ...
              <div className="grid gap-6 py-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className="bg-slate-800 border-slate-600 focus:border-teal-500"
                    placeholder="e.g., Test your core JS knowledge."
                  />
                </div>
              </div>
            )}
                ...
                <div className="max-h-[250px] space-y-3 pr-2 overflow-y-auto">
                  {quizData.questions.length > 0 ? (
                    quizData.questions.map((q, index) => (
                      <div
                        key={index}
                        className="border border-slate-700 p-3 rounded-lg flex items-center justify-between bg-slate-800/50"
                      >
            ...
            {step === 3 && (
              <div className="space-y-4 py-4 max-h-[350px] overflow-y-auto pr-2">
                <h3 className="font-semibold text-xl text-gray-100 border-b border-slate-700 pb-2">
                  Quiz Preview
                </h3>
                <div className="space-y-2">
                  <p>
                    <strong className="text-teal-400">Title:</strong>{" "}
                    {quizData.title}
                  </p>
                  <p>
                  ...
                  <p>
                    <strong className="text-teal-400">Questions:</strong>{" "}
